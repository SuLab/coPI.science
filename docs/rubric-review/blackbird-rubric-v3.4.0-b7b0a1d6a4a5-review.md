...
**Rubric version 3.4.0 · content hash `b7b0a1d6a4a5` · generated 2026-08-29 from `prompts/rubric/blackbird-rubric.toml` (document date 2026-08-29)**
...
- **Vocabulary:** the stored band value "pass" means pass ON the deal (decline) — displayed as `decline`.
...
```
3.4.0 (2026-08-29): pass_label 'pass (decline)' -> 'decline'; display-only,
stored vocabulary unchanged (recommendation/band keep writing "pass"). No
weight, threshold, gating, or dimension changes.
