...
async def test_a_verified_panel_stores_a_real_sql_null(engine):
    ...
    # Everything `required_domains_for` asks of this verdict: the two always-
    # required domains, plus chemistry (the "peptide" cue) and technologic (the
    # "platform" cue). `legal` is a surplus consult: it is cue-required on FTO
    # language, which this rationale does not contain.
