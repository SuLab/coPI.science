...
_PI_LAB = {
    ...
    DECIDE: (
        ...
        "Feasibility is the exception and it is not commercial diligence: if the hub asks "
        "whether a specific experiment could run in your lab, and roughly what it would "
        "cost and how long it would take, answer with what the lab can actually do. That "
        "is capability, not a commitment of your PI's budget. "
...
_SCOUT_HUB = {
    ...
    CONCLUDE: (
        ...
        "route-to-incubation — state a pass as \"decline\" in the visible reply; the "
        "sidecar value stays `pass`), the red flags you saw, and a confidence label. Where you "
        ...
        "There is no separate post. State a pass recommendation as \"decline\" in the "
        "visible reply; the sidecar value stays `pass`. OR\n"
