...
_SCOUT_HUB = {
    EXPLORE: (
        ...
        "where it sits on the Blackbird funnel (incubation / pre-seed / seed / follow-on), "
        "because that sets the evidence bar for everything after and determines which "
        "instrument this could ever be a candidate for. Do NOT score it yet and do NOT "
        "offer an assessment.",
    ...
    DECIDE: (
        ...
        "modality, and whether proof of mechanism is established. Once your own "
        ...
        "that scale, on that timeline. Form a view on which Blackbird instrument this "
        ...
        "up: those two decide most real Blackbird rejections and are the two this rubric "
        "historically had no way to ask about.",
