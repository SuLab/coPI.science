...
- `labbot-podcast.md` — daily personalized research briefing: PubMed search, LLM selection/summarization, ElevenLabs TTS, Slack DM delivery, per-PI RSS podcast feed
